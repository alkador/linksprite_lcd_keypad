...
// For V2.1 linksprite: 
//  btnSELECT; //val reelle 613
//  btnRIGHT; //val reelle 815
//  btnLEFT; //val reelle 856
//  btnDOWN; //val reelle 903
//  btnUP; //val reelle 930
// les valeurs doivent etre ordonnées pour la detection 
const int c_ButtonAnalogValue_None = 1024;
const int c_ButtonAnalogValue_1 = 613; // select 
const int c_ButtonAnalogValue_2 = 815; // right
const int c_ButtonAnalogValue_3 = 856; // left
const int c_ButtonAnalogValue_4 = 903; // down
const int c_ButtonAnalogValue_5 = 930; // up
const char* Button_name_1 = "select"; // select 
const char* Button_name_2 = "right"; // right
const char* Button_name_3 = "left"; // left
const char* Button_name_4 = "down"; // down
const char* Button_name_5 = "up"; // up
const int c_ButtonAnalogValue_Error = 10;
